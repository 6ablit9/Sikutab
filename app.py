...
st.markdown(
    ...
    /* ESTO JUNTA LOS CÍRCULOS: Anula el ancho automático de Streamlit */
...
# --- SIKU VIRTUAL (LIMPIO Y COMPACTO) ---
...
# --- FILAS ---
# Arka: Label(1.5) + 7 notas(1 cada una)
...
# Ira: Label(1.5) + DESFASE EXACTO(3.5 para alinear con el DO) + 6 notas
# Para que la Ira flote centrada bajo el Do, necesitamos que el desfase sea elástico
# Usamos una columna vacía para el espacio
